...
from modeling import BertForSentenceExtraction_DeepHidden
...
def main():
    ...
    parser.add_argument("--predict_multi_model",
                        action='store_true',
                        help="Predict multiple model or not")
    ...
    logger.info("Predict Multiple Model : {}".format(args.predict_multi_model))
    ...
    if args.predict_multi_model == False:
        args.start_epochs = args.end_epochs
