...
def main():
    ...
    Eval_path = '/notebooks/papers/my_code/output_ver4/1-5_epoch_window_2_2000_doc/'
    EvalModel_list = ['0_epoch_window_2','1_epoch_window_2','2_epoch_window_2','3_epoch_window_2','4_epoch_window_2','5_epoch_window_2']
    logger.info("***** Only Do Evaluation *****")

    for model_name in EvalModel_list:
        model_file = os.path.join(Eval_path, "pytorch_model_{}.bin".format(model_name))
        ...
        output_eval_file = os.path.join(Eval_path, "eval_results_{}.txt".format(model_name))
