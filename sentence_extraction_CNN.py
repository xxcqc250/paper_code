...
from modeling import BertForSentenceExtraction_CNN,BertForSequenceClassification
            ...
            if args.save_every_epoch:
                ...
                if args.do_eval and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
                    ...
                    with open(output_eval_file, "w") as writer:
                        writer.write("****** eval_results_{}_epoch_{}.txt ******\n\n".format(epoch,args.output_model_name))
